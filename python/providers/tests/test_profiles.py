...
from jharness.providers.deepseek import deepseek_anthropic_profile, deepseek_openai_chat_profile
from jharness.providers.openai import OpenAIChatCompletionsModel, OpenAIChatCompletionsProfile


@pytest.mark.parametrize("model_type", [OpenAIChatCompletionsModel, AnthropicModel])
def test_provider_clients_share_constructor_validation(model_type: type[object]) -> None:
